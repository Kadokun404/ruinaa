...
// Akses lewat: POST https://ruina.z-hiruira.biz.id/api/ruina
//
// PENTING — soal API key:
//   - JANGAN PERNAH menulis API key langsung di file ini.
//   - Set lewat Vercel → Project Settings → Environment Variables,
//     dengan nama ANTHROPIC_API_KEY.
//   - Kalau ada API key yang sempat ke-paste di chat / commit / file lain,
//     anggap key itu BOCOR — cabut (revoke) di console.anthropic.com
//     dan generate key baru. Key yang sudah pernah terlihat orang lain
//     (termasuk dalam riwayat chat) tidak lagi aman dipakai.
